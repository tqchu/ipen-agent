...
class Result:
    ...
    def __init__(self, reward: float,
                 ...
                 open_ports: dict[str: list[int, str]] = None,
                 vulners: dict[str: list[int, list[str]]] = None,
                 future_actions: list[PentestAction] = None,
                 status: str = None, details: dict = None,
                 hosts_shell: dict[str: ShellType] = None,
                 hosts_meterpreter: dict[str: ShellType] = None,
                 usernames: dict[str: str] = None,
                 credentials: dict[str: (str, str)] = None,
                 tokens: dict[str: str] = None,
                 privileges: dict[str: Privilege] = None,
                 ):
        """
